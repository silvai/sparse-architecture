...
print("-------------------------------------------")
a_hat = np.identity(5)
a_hat = model.predict(a_hat).transpose()
...
print("A:\n", real_A)
print("Difference:\n", difference_a)
print("\nMagnitude of difference using Identity: ", np.linalg.norm(difference_a).round(0))
print("-------------------------------------------------------")


estimated_output = model.predict(train_x[0:5])
inverse_x = np.linalg.inv(train_x[0:5])
a_hat_est = np.matmul(inverse_x, estimated_output).transpose()
a_hat_est = a_hat_est.round(0)
...
print("A_hat_est:\n", a_hat_est)
# print("Difference:\n", difference_b)
print("\nMagnitude of difference using Algebra: ", np.linalg.norm(difference_b).round(0))
print("-------------------------------------------------------")
